...
def build_formulario_cliente_html(cat_items, config_data, resps_map, supa_url, supa_key, ep, nombre_cliente, logo_b64='', hero_b64=''):
    ...
    # Icono por categoría detectado del título (sin acentos, case-insensitive).
    ...
    _CAT_ICONS = [
        ...
        (('cornisa', 'moldura', 'guardapolvo', 'zocalo'),
    ...
    def _cat_icon(nombre):
        ...
        for keys, path in _CAT_ICONS:
            if any(k in n for k in keys):
                return _svg(path, 18, 18, 2, '#0f3460')
        return _svg(_CAT_ICON_DEFAULT, 18, 18, 2, '#0f3460')
