 ...
 with tab2:
    ...
    <div class="hdr2" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Completa la información del cliente y del proyecto antes de guardar.</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
 ...
 with tab1:
    ...
    <div class="hdr1" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Agrega productos, aplica márgenes y genera tu cotización en PDF.</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
 ...
 with tab3:
    ...
    <div class="hdr3" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Busca, carga y administra todas las cotizaciones del sistema.</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
 ...
 with tab4:
    ...
    <div class="hdr4" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Selecciona un presupuesto con plano adjunto para generar su prototipo 3D interactivo.</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
...
if st.session_state.get('es_root') and tab_salud is not None:
    with tab_salud:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Monitoreo de capacidad y estado de Supabase — Plan Core (actualizado al cargar)</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
...
if tab_admindata is not None:
    with tab_admindata:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Eliminación permanente de presupuestos y archivos · Solo disponible para root</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
 ...
 with tab_reporte:
    ...
    <div class="hdr-reporte" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Espacio Container House SpA · Período: {_rep_periodo} · Solo admin y root</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
 ...
 with tab_oper:
    ...
    <div class="hdr-oper" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">PDF de compras · planos · seguimiento de fabricación y fidelización de clientes</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
...
if tab6 is not None:
    with tab6:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Busca tu cotización por número EP y personaliza la descripción de cada categoría para el cliente.</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
...
if tab7 is not None:
    with tab7:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Desempeño del equipo de ventas — este mes.</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
 ...
 with tab_contrato:
    ...
    <div class="hdr-contrato" style="display:flex!important;align-items:center!important;">
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Genera y administra el contrato de fabricación y venta.</div>
      </div>
    </div>
    """, unsafe_allow_html=True)
...
if st.session_state.modo_admin and tab_usuarios is not None:
    with tab_usuarios:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Crea y administra las cuentas de acceso de los ejecutivos.</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
...
if tab_notif is not None and st.session_state.get('es_supervisor'):
    with tab_notif:
      ...
      <div style="margin-left:16px;">
        ...
        <div style="font-family:Montserrat,sans-serif;font-weight:400;font-size:0.92rem;color:rgba(255,255,255,0.65);margin-top:2px;line-height:1.2;">Configura Telegram, contactos, observadores y mensajes automáticos.</div>
      </div>
    </div>
        """, unsafe_allow_html=True)
