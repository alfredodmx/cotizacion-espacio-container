        ...
        if not _rc_cots:
            ...
            if _rc_ep:
                ...
                if not _rc_prods:
                    ...
                    _rc_html = (
                        "<style>html,body{margin:0;padding:0;font-family:'Segoe UI',sans-serif;font-size:13px;}"
                        "body{display:flex;flex-direction:column;height:"+str(min(len(_rc_prods)*37+310, 720))+"px;overflow:hidden;}"
