...
from views.tab_clientes        import render_tab_clientes
...
from views.tab_sitio_web        import render_tab_sitio_web
...
_PAGES = {
    ...
    'sitio_web':      ('Sitio web',          'sitio_web',      lambda: render_tab_sitio_web(**_deps)),
