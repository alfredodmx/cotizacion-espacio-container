...
<td style="padding:5px 8px;font-size:.85rem;color:#334155;font-weight:700">{cat}</td>
<td style="padding:5px 8px;font-size:.95rem;color:#0f172a;font-weight:700">{item}</td>
...
<td></td>
    ...
    html = f"""<style>
html,body{{margin:0;padding:0;font-family:'Segoe UI',sans-serif;font-size:13px;height:100%;overflow:hidden}}
