...
def generar_pdf_completo(carrito_df, subtotal, iva, total, datos_cliente,
    ...
    styles.add(ParagraphStyle(name='NotasEstilo', parent=styles['Normal'], fontSize=9, leading=13, leftIndent=0, alignment=0, textColor=colors.grey, spaceAfter=2))
    ...
    # 2 columnas: notas+mensaje (izq) | totales (der), ambos centrados verticalmente
    _tbl_izq = Table(
        [[bloque_notas], [_msg_cordial]],
        colWidths=[ancho_bloque]
    )
    _tbl_izq.setStyle(TableStyle([
        ('ALIGN',  (0,0), (-1,-1), 'LEFT'),
        ('VALIGN', (0,0), (-1,-1), 'TOP'),
    ...
    data_bloques = [[_tbl_izq, totales_tabla]]
