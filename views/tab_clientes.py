...
/* Etiqueta pequeña bajo cada botón-ícono. Se saca del flujo (absolute) y queda
   PEGADA al botón (no empuja la altura de la fila). */
...
div[data-testid="stElementContainer"]:has(.cli-btncap){
  position:absolute!important;top:100%!important;left:0;right:0;margin-top:3px!important;}
/* Línea del selector (PIPELINE/BANDEJA/MAESTRO) a lo ancho de TODA la barra, POR
   DEBAJO de los textos de los botones (borde inferior + padding que la baja). */
div[data-testid="stHorizontalBlock"]:has(> div[data-testid="stColumn"] .st-key-_cli_view){
  border-bottom:2px solid #e2e6f3!important;padding-bottom:18px!important;}
</style>
"""
...
.cli-actf-h{font-family:Montserrat,sans-serif;font-weight:800;font-size:0.92rem;letter-spacing:0.03em;
  text-transform:uppercase;color:#0f172a;margin:0 0 11px;display:flex;align-items:center;gap:9px;}
.cli-actf-h::before{content:'';width:4px;height:16px;border-radius:3px;flex-shrink:0;
...
.st-key-_cli_edit_form label p,.st-key-_cli_edit_form [data-testid="stWidgetLabel"] p{
  font-size:0.74rem!important;font-weight:700!important;letter-spacing:0.02em!important;
...
_FUENTE_META = {
    ...
    "formulario modelo prediseñado": ("Formulario Modelo Prediseñado", '<path d="M3 9 12 2l9 7"/><path d="M5 10v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V10"/><path d="M9 21v-6h6v6"/>', "#b45309", "rgba(180,83,9,.13)"),
    "formulario personalizado": ("Formulario Personalizado", '<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>', "#9a3412", "rgba(154,52,18,.13)"),
...
def _note_meta(note) -> dict:
    ...
    return {
        ...
        "modulo": _nfirst(_d, "módulo", "modulo"),
        "puertas_ventanas": _nfirst(_d, "puertas y ventanas", "puertas/ventanas", "puertas"),
        "revestimiento": _nfirst(_d, "revestimiento"),
        "distribucion": _nfirst(_d, "distribución", "distribucion"),
    }
...
_SHOPIFY_TAG_ORIGEN = {
    ...
    "formulario modelo prediseÃ±ado": "Formulario Modelo Prediseñado",  # compat encoding raro de la ñ
    "cotizacion-multipaso": "Formulario Modelo Prediseñado",       # compat etiqueta anterior del multipaso
    "formulario personalizado": "Formulario Personalizado",        # container-configurator.liquid
    "configurador-container": "Formulario Personalizado",          # compat etiqueta anterior del configurador
}
...
_SHOPIFY_META_LABELS = [
    ("modelo", "Modelo"), ("precio", "Valor / precio"),
    # Configurador (FORMULARIO PERSONALIZADO):
    ("modulo", "Módulo"), ("puertas_ventanas", "Puertas y ventanas"),
    ("revestimiento", "Revestimiento"), ("distribucion", "Distribución"),
    ("presupuesto", "Presupuesto"), ("region", "Región"), ("plazo", "Plazo ideal"),
    ...
    def _dlg():
        ...
        if st.session_state.get("_cli_act_open"):
            with st.container(border=True, key="_cli_act_form"):
                ...
                with st.container(key=f"_cli_actbody_{_tipo}"):
