    ...
    setTimeout(initEPCopy,500);
        ...
        if opciones:
            ...
            _dd_html_tpl = (
                ...
                "if(!PD.getElementById('_ecdd_css3')){['_ecdd_css','_ecdd_css2'].forEach(function(id){var el=PD.getElementById(id);if(el)el.remove();});var _s=PD.createElement('style');_s.id='_ecdd_css3';"
                ...
                "if(inp){var _nv=Object.getOwnPropertyDescriptor(window.parent.HTMLInputElement.prototype,'value').set;_nv.call(inp,ep);inp.dispatchEvent(new window.parent.Event('input',{bubbles:true}));inp.focus({preventScroll:true});setTimeout(function(){inp.dispatchEvent(new window.parent.KeyboardEvent('keydown',{key:'Enter',code:'Enter',keyCode:13,which:13,bubbles:true}));},10);}}"
