...
def _cn_badge(adjudicado):
    ...
    _fam = "font-family:'Plus Jakarta Sans',sans-serif;"  # misma fuente que el badge de Cotizaciones
    if adjudicado:
        return ('<span style="display:inline-flex;align-items:center;gap:4px;background:#2563eb;color:#fff;'
                ...
                + _fam + 'box-shadow:0 2px 5px rgba(37,99,235,.25);white-space:nowrap;">'
